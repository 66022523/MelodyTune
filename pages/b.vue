        ...
        <main class="text-2xl w-2/3 max-md:w-full max-lg:text-lg">
          <article>
            <p class="leading-9 tracking-wide">
              หนึ่งในเรื่องราวจากเพลง “เธอชอบมันหรือชอบร้องไห้มากกว่ากัน -
              HardBoy” เพลงใหม่จากคณะ Hard Boy ค่าย Gene Labเจ้าของเพลง “Kiss
              MeBaby,ค่ำคืนนั้น”
              ที่คราวนี้กลับมาพร้อมเพลงเตือนสติให้คิดได้สักที“ว่าถ้าเขารักเราจริง
              เขาไม่ทำแบบนี้หรอก”
            </p>
            <br />
